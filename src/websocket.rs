...
pub async fn connect_to_server(args: &Args) -> Result<WebSocketStream<MaybeTlsStream<TcpStream>>, Fe2IoError> {
...
pub async fn reconnect_to_server(args: &Args) -> Result<WebSocketStream<MaybeTlsStream<TcpStream>>, Fe2IoError> {
